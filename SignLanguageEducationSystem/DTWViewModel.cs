...
using NDtw;
using SignLanguageEducationSystem.Infrastructure;
using SignLanguageEducationSystem.Infrastructure.MultiSelect;
using NDtw.Preprocessing;

namespace SignLanguageEducationSystem
{
    public class DTWViewModel : ViewModelBase
    {
        public DTWViewModel()
        {
            InitializeData();
        ...
        public bool ShowVertical
        {
            ...
            set
            {
                ...
                NotifyPropertyChanged(() => ShowVertical);
            }
        }

        private bool _showHorizantal;

        public bool ShowHorizantal
        {
            get { return _showHorizantal; }
            set
            {
                _showHorizantal = value;
                if (value && DrawCost)
                    DrawCost = false;

                NotifyPropertyChanged(() => ShowHorizantal);
            }
