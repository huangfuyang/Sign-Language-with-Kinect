...
namespace CURELab.SignLanguage.Debugger
{
    class GraphView
    {
        ...
        public LineGraph AddSplitLine(int split, double stroke, double min, double max)
        {
            ...
            return _chartPlotter.AddLineGraph(v_right, Colors.Black, stroke, "seg line");
        }
        ...
        public void DrawSigner(int split, double min, double max)
        {
            ...
            lastSigner = AddSplitLine(split, 1, min, max);
